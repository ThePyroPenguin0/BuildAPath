class Path extends Phaser.Scene {
    ...
    create() {
        ...
        console.log("Created enemyShip?\n");
        console.log(my.sprite.enemyShip);
    ...
    update() {
        ...
        if (Phaser.Input.Keyboard.JustDown(this.oKey)) {
            ...
            console.log("[\n");
            for (let n = 0; n < this.curve.points.length; n++) {
                if (n+1 < this.curve.points.length) {
                    console.log(this.curve.points[n].x + ", " + this.curve.points[n].y + ",\n");
                }
                else {
                    console.log(this.curve.points[n].x + ", " + this.curve.points[n].y + "\n");
                }
